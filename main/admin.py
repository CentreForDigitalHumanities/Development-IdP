...
from .models import Affiliation, Entitlement, User
...
class UserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (_("Personal info"), {"fields": ("sn", "givenName", "displayName")}),
        (
            _("Organizational"),
            {
                "fields": (
    ...
    list_display = ("username", "givenName", "sn", "is_staff")
    list_filter = ("is_staff", "is_superuser", "is_active",)
    search_fields = ("username", "givenName", "sn", "displayName")
    ordering = ("username",)
    filter_horizontal = []
